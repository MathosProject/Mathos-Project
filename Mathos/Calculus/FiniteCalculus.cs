...
namespace Mathos.Calculus
{
    ...
    public static class FiniteCalculus
    {
        ...
        /// <param name="sequence">The sequence of doubles passed in as a double array.</param>
        /// <param name="degree">The degree value returned here is the number of times we have to take the differnce of this sequence (using GetDifference) to get the difference to be zero.</param>
        /// <param name="checkAllTerms">By default, we only check if we can get any kind of difference (of different degrees) to be zero for the smallest term. If this option is true, all terms are going to be checked to follow the pattern.</param>
        /// <returns></returns>
