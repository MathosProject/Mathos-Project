...
namespace Mathos.Arithmetic
{
    namespace ComplexNumbers
    {
        ...
        public struct ComplexNumber
        {
            ...
            public ComplexNumber(long inRealPart)
            {
            ...
            public ComplexNumber(int inRealPart, int inImaginaryPart)
            {
                _realPart = inRealPart;
            ...
            {
                return _realPart.Equals(other._realPart) && _imaginaryPart.Equals(other._imaginaryPart);
            }
            ...
            public override int GetHashCode()
            {
                unchecked
                {
                    return (_realPart.GetHashCode() * 397) ^ _imaginaryPart.GetHashCode();
                }
            }
        ...
        public static class ComplexOperation
        {
            ...
            /// <param name="number"></param>
            /// <returns></returns>
            public static ComplexNumber Sqrt(short number)
            {
            ...
            /// <param name="number"></param>
            /// <returns></returns>
            public static ComplexNumber Sqrt(int number)
            {
                return Sqrt((double)number);
            } 
            ...
            /// <param name="number"></param>
            /// <returns></returns>
            public static ComplexNumber Sqrt(long number)
            {
                return Sqrt((double)number);
            }
